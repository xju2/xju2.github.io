...
\begin{itemize}
\item Supervising the undergraduate student, Allison Xu, who received the US ATLAS Summer Undergraduate Program for Exceptional Researches (SUPER), Fall 2019 --- Present.
\item Supervising undergraduate three students from University of Washington in studying the robustness of Graph Neural Network, Summer 2020 --- Present.
\item Supervising an undergraduate student from UC Berkeley in studying the cluster shape effect.
\item Supervised undergraduate students from UC Berkeley through the Undergraduate Research Apprentice Program (URAP), Fall 2018, Spring 2019, Fall 2019 and Spring 2020.
\item Lectured General Physics (Electricity and Magnetism) for about 50 undergraduate students from University of Wisconsin-Madison, Spring \& Fall, 2014.
%%\item 2014 Fall: Teach 50 undergraduate students general physics
%\newline \indent \href{http://www.wisc.edu}{University of Wisconsin-Madison, US}
%%\newline \indent \textbf{Subject:} Electric and Magnetism, Optical and relavent experiments
